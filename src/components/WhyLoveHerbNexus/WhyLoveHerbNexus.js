  ...
  return (
    <Container className="why-love-herbnexus">
      ...
      <div className="image-container">
        <picture>
          <source media="(max-width: 767px)" srcSet="/herbnexus/src/assets/why-love-ja-mobile-new.png" />
          <source media="(min-width: 768px)" srcSet="/herbnexus/src/assets/why-love-ja.png" />
          <img src="/herbnexus/src/assets/why-love-ja.png" alt="Herb Nexus" className="bottom-image" />
        </picture>
      </div>
    </Container>
  );
